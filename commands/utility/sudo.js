module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (!user) return message.channel.send("Hey listen if you are using this command then plz first whitelist the bot from webhooks because this bot makes webhook in this command!");
